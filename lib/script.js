              ...
              _.forEach(tiers[firstTier], function(actor){
                ...
                _self._rehearse(scene.getOpeningLine(), actor, _self.stagehand.getLiveUrl(actor.getSetName()), function(response){
                  ...
                  scene.getLine(newLine, function(line){
                    var sceneDesc = scene.getId() + ' - ' + scene.getOpeningLine();
                    ...
                    if(line != undefined){
                      ...
                      if(line.getLineOut() == newLine.getLineOut()){
                        ...
                        critic.record('Successes', act.getTitle(), sceneDesc, actor.getName(), undefined, undefined);
                        
                      }else{
                        // otherwise the test failed
                        console.log('FAILURE: GOT - ' + newLine.getLineOut() + '  --- EXPECTED - ' + line.getLineOut());
                        critic.record('Failures', act.getTitle(), sceneDesc, actor.getName(), newLine.getLineOut(), line.getLineOut());
                      }
                      linesRead++;
                      ...
                      newLine.save(function(success){
                        critic.record('New Additions', act.getTitle(), sceneDesc, actor.getName(), newLine.getLineOut(), undefined);
                        linesRead++;
                      });
                    }
